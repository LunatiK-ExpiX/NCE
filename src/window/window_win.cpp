...
namespace window {
	...
	void create_window(sys::state& game_state, creation_parameters const& params) {
		...
		game_state.win_ptr->hwnd = CreateWindowExW(0, L"project_alice_class", L"NCE", win32Style, CW_USEDEFAULT, CW_USEDEFAULT, 0, 0, NULL, NULL, GetModuleHandleW(NULL), &game_state);
	...
	void emit_error_message(std::string const& content, bool fatal) {
		static const char* msg1 = "NCE has encountered a fatal error";
		static const char* msg2 = "NCE has encountered the following problems";
